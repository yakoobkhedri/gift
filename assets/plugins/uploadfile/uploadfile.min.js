...
//    }
    ...
    $.fn.uploadFile = function(options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "btn btn-round btn-primary ajax-file-upload",
            dragDropStr: "<span><b>فایل خود را بکشید و رها کنید</b></span>",
            uploadStr: "افزودن عکس",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "<i class='fa fa-trash-o'></i>",
            doneStr: "Done",
            multiDragErrorStr: "درگ کردن چند فایل همزمان مجاز نیست.",
            extErrorStr: "فقط مجاز به ورود فایل با فرمت های روبرو می باشید :",
            duplicateErrorStr: "فایل انتحابی از قبل وجود دارد.",
            sizeErrorStr: "فایل انتخابی بزرگ از سایز مجاز می باشد. سایز مجاز :  ",
            uploadErrorStr: "خطا در بارگذاری",
            maxFileCountErrorStr: "تعداد فایل ها بیش از حد مجاز. تعداد مجاز : ",
        ...
        this.createProgress = function(filename, filepath, filesize) {
            ...
            fileNameStr += "<input type='hidden' value='"+filename+"' name='images[]'>";
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                fileNameStr += "<input type='hidden' value='"+files[i].name+"' name='images[]'>";
...
//                    $(this).html(name);
//                    $(this).parent().find(".ajax-file-upload-preview").hide();
//                    count--;
//                });
//            }
        }
        ...
        function defaultProgressBar(obj, s)
        {
            ...
            this.preview = $("<img class='ajax-file-upload-preview' />").appendTo(this.statusbar);
            ...
            this.del = $("<div>" + s.deletelStr + "</div>").appendTo(this.statusbar);

            this.abort.addClass("ajax-file-upload-red");
            this.done.addClass("ajax-file-upload-green");
            this.download.addClass("ajax-file-upload-green");
            this.cancel.addClass("ajax-file-upload-red");
            this.del.addClass("ajax-file-upload-red ajax-file-upload-delete");
